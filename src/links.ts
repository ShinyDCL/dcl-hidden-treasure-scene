...
export const URLS: Record<LinkType, string> = {
  [LinkType.GITHUB]: 'https://github.com/ShinyDCL/dcl-hidden-treasure-scene',
  [LinkType.TWITTER]: 'https://twitter.com/ShinyDCL/status/1665392365064814592',
  [LinkType.MUSIC]:
    'https://opensea.io/assets/matic/0x2953399124f0cbb46d2cbacd8a89cf0599974963/25486900035804141438897435195658448120910728073030870014422397470392444782044'
} as const
